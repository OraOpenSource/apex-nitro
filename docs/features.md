...
When you have launched APEX Nitro, a service runs in the background and watches for any changes made to any files within your project source directory. When a change is detected, APEX Nitro recompiles the source code and injects it automatically to your APEX application through web socket technologies.

![](img/feature-browsersync.gif)
...
1. `/project/dist/js/app.min.js` *(minified)*:
```javascript
...
![](img/feature-sourcemaps-1.png)

Clicking on the link opens the code, and shows this mess:
![](img/feature-sourcemaps-2.png)
...
![](img/feature-error-js.png)

**Example of a CSS error warning:**
![](img/feature-error-css.png)
...
### CSS Preprocessing
A CSS preprocessor is a program that allows generation of CSS from the preprocessor's own unique syntax making the CSS structure more readable and easier to maintain. The main benefits of CSS preprocessors are to implement CSS variables, nesting and functions. APEX Nitro comes pre-wired for SASS and Less.
...
By activating the Ghost Mode option of your project configuration, you can make responsive design development much easier.
![](img/feature-responsive-1.png)

Then when you do `apex-nitro launch <project>`, look for the external URL:
![](img/feature-responsive-2.png)

By going to that URL on the same network, all devices synchronize together as far as navigating, clicking, typing and scrolling.

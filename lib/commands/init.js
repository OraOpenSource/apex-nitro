...
const initConfig = async function(questions) {
	...
	// Set js defaults
	if (answers.mode === "advanced" && config.js.defaults === "default") {
	...
	// Set css defaults
	if (answers.mode === "advanced" && config.cssDefaults === "default") {
	...
	if (answers.mode === "advanced" && config.browsersync.defaults === "default") {
	...
	if (answers.mode === "advanced" && config.publish.defaults === "default") {

...
const questions = [{
	...
	default: true,
	when(answers) {
		return answers.mode === 'advanced' && answers.js.defaults === 'custom' && answers.js.processor === 'javascript';
	}
}, {
	type: 'input',
	...
	default: 'app',
	when(answers) {
		return answers.mode === 'advanced' && answers.js.defaults === 'custom' && answers.js.processor === 'javascript' && answers.js.jsConcat;
	},
	validate: isRequired
}, {
	type: 'confirm',

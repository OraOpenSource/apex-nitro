...
const ApexNitroPro = require('../pro/apex-nitro-pro');
...
const initConfig = async function(questions) {
	...
	// Set js defaults
	if (config.mode === 'advanced' && config.js.defaults === 'default') {
	...
	// Set css defaults
	if (config.mode === 'advanced' && config.cssDefaults === 'default') {
	...
	if (config.mode === 'advanced' && config.browsersync.defaults === 'default') {
	...
	if (config.mode === 'advanced' && config.publish.defaults === 'default') {

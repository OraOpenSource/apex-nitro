                            ...
                            <div class="row">
                                <div class="col s12">
                                    <div class="input-field">
                                        ...
                                        <input type="text" id="appURL" class="validate" name="appURL" value="${config.appURL}" required placeholder="Example: https://apex.oracle.com/pls/apex/f?p=12192">
                        ...
                        <div class="collapsible-body">
                            ...
                            <div class="row">
                                <div class="col s6 input-field">
                                    <i class="material-icons prefix tooltipped" data-position="top" data-tooltip="Pick your APEX version.">help</i>
                                    <select id="sqlcl_apexVersion" name="sqlcl_apexVersion">
                                        <option value="">- Select -</option>
                                        <option value="apex_050000" ${(config.sqlcl.apexVersion == "apex_050000" ? "selected" : "")}>5.0</option>
                                        <option value="apex_050100" ${(config.sqlcl.apexVersion == "apex_050100" ? "selected" : "")}>5.1</option>
                                    </select>
                                    <label>APEX Version</label>
                                </div>
                                <div class="col s12 input-field">
                                    ...
                                    <input type="text" id="sqlcl_path" name="sqlcl_path" value="${config.sqlcl.path}" placeholder="Example: sql">
                                    <label for="sqlcl_path">SQLcl Path</label>
                                </div>
                                <div class="col s12 input-field">

            ...
            <body>
                <form action="/saveConfig" method="post">
                    ...
                    <div class="nav-wrapper container">
                        ...
                        <ul class="right">
                            <li>
                                <button class="btn waves-effect waves-light secondary-color-bg" type="submit" name="action">
                                    Save
                                </button>
                            </li>
                        </ul>
  ...
  /__/     \__\ |__|     |_______||______/
    ...
    configSavedHTML: function(project) {
        let body = `
            <div class="section">
                <div class="container">
                    <h1 class="header center secondary-color-text">${project}</h1>
    ...
    configFormHTML: function(project, config) {
        let body = `
            <div class="no-container">
                <div class="row">
                    <div class="col s12">
                        <h2 class="header center primary-color-text">${project}</h1>
                    </div>
                    <!-- Global -->
                    ...
                    <div class="col m4 s12">
                        <!-- jsConcat -->
                        <h5 class="header secondary-color-text">JavaScript Concatenation</h5>
                        <div class="row">
                        ...
                        <!-- /jsConcat -->
                        <!-- cssConcat -->
                        <h5 class="header secondary-color-text">CSS Concatenation</h5>
                        <div class="row">
                            <div class="col s3 input-field switch-fix">
                                <div class="switch">
                                    <label>
                    ...
                    <div class="col m4 s12">
                        <!-- Sass -->
                        <h5 class="header secondary-color-text">Sass</h5>
                        <div class="row">
                            <div class="col s3 input-field switch-fix">
                                <div class="switch">
                                    <label>
                        ...
                        <!-- /Sass -->
                        <!-- Less -->
                        <h5 class="header secondary-color-text">Less</h5>
                        <div class="row">
                            <div class="col s3 input-field switch-fix">
                                <div class="switch">
                                    <label>
                ...
                <div class="row">
                    <div class="col m4 s12">
                        <!-- Browsersync -->
                        <h5 class="header secondary-color-text">Browsersync</h5>
                        <div class="row">
                    ...
                    <div class="col m4 s12">
                        <!-- Header -->
                        <h5 class="header secondary-color-text">Header</h5>
                        <div class="row">
                            <div class="col s3 input-field switch-fix">
                                <div class="switch">
                                    <label>
                ...
                <div class="row">
                    <div class="col s12">
                        <h5 class="header secondary-color-text">Theme Roller</h5>
                        <div class="row">

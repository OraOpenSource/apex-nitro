...
module.exports = class BasicModeInitializer {
	async init(config) {
		...
		basicModeConfig.launch.openApp = true;
		...
		basicModeConfig.upload.path = 'sql';
		basicModeConfig.upload.username = '';
		basicModeConfig.upload.password = '';
		basicModeConfig.upload.connectionString = '';
